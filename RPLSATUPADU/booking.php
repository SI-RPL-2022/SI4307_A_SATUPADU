...
<div class="container-fluid">
    <form action="" id="booking-form">
        ...
        <div class="form-group">
            ...
            <input name="date_from" id="date_from" type="datetime-local" class="form-control form-control-sm rounded-0" required />
        </div>
        <div class="form-group">
            <label for="date_to" class="control-label">To Date</label>
            <input name="date_to" id="date_to" type="datetime-local" class="form-control form-control-sm rounded-0" required />
        </div>
    </form>
</div>
